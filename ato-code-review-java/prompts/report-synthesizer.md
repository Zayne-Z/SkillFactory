...
第五节领域块：`{{CORE_ISSUES_DETAIL}}`、`{{SPRING_ISSUES_DETAIL}}`、`{{SECURITY_ISSUES_DETAIL}}`、`{{DATA_ISSUES_DETAIL}}`（以 `report-template.md` 为准）。
