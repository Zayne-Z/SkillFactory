...
|---|---------|------|------|-----------|--------|------|------|------|---------|------|--------|------|
| 1 | SEC-004 | OrderController.java | 52 | OrderController#create | 张三 | Critical | 是 | 安全 | 创建订单未绑定当前登录用户，存在水平越权 | 否 | 否 | [查看](#issue-SEC-004) |
| 2 | SPR-012 | OrderServiceImpl.java | 102 | OrderServiceImpl#createOrder | 李四 | High | 是 | Spring | 事务自调用导致 notifyWarehouse 不在同一事务 | 否 | 否 | [查看](#issue-SPR-012) |
| 3 | SPR-015 | OrderController.java | 47 | OrderController#create | 张三 | High | 是 | Spring | 缺少幂等控制，重复提交可 duplicate order | 否 | 否 | [查看](#issue-SPR-015) |
| 4 | DAT-008 | OrderMapper.xml | 28 | OrderMapper.xml#batchInsertItems | 王五 | High | 是 | 数据与性能 | `${tableSuffix}` 动态表名存在 SQL 注入风险 | 否 | 否 | [查看](#issue-DAT-008) |
| 5 | COR-003 | OrderServiceImpl.java | 89 | OrderServiceImpl#createOrder | 李四 | Medium | 否 | 核心静态 | getItems() 可能 NPE | 否 | 否 | [查看](#issue-COR-003) |
| 6 | DAT-011 | OrderServiceImpl.java | 118 | OrderServiceImpl#loadOrderDetail | 李四 | Medium | 否 | 数据与性能 | 循环查库 N+1 | 否 | 否 | [查看](#issue-DAT-011) |
| 7 | COR-007 | OrderAsyncConfig.java | 34 | OrderAsyncConfig#orderExecutor | 赵六 | Low | 否 | 核心静态 | 无界队列容量风险 | 否 | 否 | [查看](#issue-COR-007) |
| 8 | DAT-014 | OrderMapper.xml | 41 | OrderMapper.xml#listByStatus | 王五 | Low | 否 | 数据与性能 | SELECT * 列表查询列过多 | 否 | 否 | [查看](#issue-DAT-014) |
